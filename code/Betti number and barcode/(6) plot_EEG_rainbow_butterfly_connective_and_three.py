...
for couple in couples:
    for cutoff in cutoffs:
        ...
        # np.save('/mnt/ufs18/home-192/jiangj33/KeLu/desktop/eeg/h_npy/s__couplematrix_cutoff_%.3f_couple_%.3f.npy'%(cutoff,couple),mat)
        np.save(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_singlec03s10_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple),singlec03s10)
        np.save(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_amplitudezc03s10_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple),amplitudezc03s10)
        np.save(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_couplematrix_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple),mat)
        ...
        np.save(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_feature_cutoff_%.3f_couple_%.3f.npy' % (subjectID[0],cutoff,couple), feature)
        ...
        singlemat = np.load(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_singlec03s10_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple))
        amplitudemat = np.load(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_amplitudezc03s10_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple))
        couplemat = np.load(r'D:\python\result\EEG\npy\couple_npy\amplitudezc03s10_npy/%s_couplematrix_cutoff_%.3f_couple_%.3f.npy'%(subjectID[0],cutoff,couple))
        ...
        # plt.savefig('/mnt/ufs18/home-192/jiangj33/KeLu/desktop/eeg/picture/h_hpcc_electrode_number_time_filtration_%.2f_couple_%.2f.png' % (cutoff, couple), dpi=1200, bbox_inches ='tight')
        plt.savefig(r'D:\python\result\EEG\fig\couple_2.8\新建文件夹/%s_hpcc_electrode_number_time_filtration_%.2f_couple_%.2f.pdf' % (subjectID[0],cutoff, couple), dpi=1200, bbox_inches ='tight')
        # plt.savefig(r'/public/home/chenlong666/desktop/my_desk1/h01task/figure/h_hpcc_electrode_number_time_filtration_%.2f_couple_%.2f.svg' % (cutoff, couple), dpi=1200, bbox_inches ='tight')
        # plt.show()
        plt.close()
        ...
        plt.savefig(r'D:\python\result\EEG\fig\couple_2.8\新建文件夹/%s_hpcc_X_Z_filtration_%.3f_couple_%.3f.pdf' % (subjectID[0],cutoff, couple), dpi=1200,bbox_inches ='tight')
        ...
        plt.savefig(r'D:\python\result\EEG\fig\couple_2.8\新建文件夹/%s_hpcc_corr_matrix_filtration_%.3f_couple_%.3f.pdf' % (subjectID[0],cutoff, couple),dpi=1200, bbox_inches ='tight')
        ...
        # plt.savefig('/mnt/ufs18/home-192/jiangj33/KeLu/desktop/eeg/picture_all/couple_%.3f_cutoff_%.3f_all_h.png' % (couple,cutoff ), bbox_inches='tight')
        plt.savefig(r'D:\python\result\EEG\fig\couple_2.8\新建文件夹/couple_%.3f_cutoff_%.3f_all_%s.pdf' % (couple,cutoff,subjectID[0] ), bbox_inches='tight')
        plt.close()
