...
plt.savefig('/mnt/ufs18/home-192/jiangj33/KeLu/desktop/eeg/picture_all/cutoff_%.3f_couple_%.3f_all_h.png' % (cutoff,couple ), bbox_inches='tight')
# plt.savefig('/mnt/ufs18/home-192/jiangj33/KeLu/desktop/eeg/picture_all_s/cutoff_%.3f_couple_%.3f_all_s.png' % (cutoff,couple ), bbox_inches='tight')
plt.close()
