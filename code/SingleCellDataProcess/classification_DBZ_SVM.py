...
def compute5foldClassification(X_ccp, y_true, max_state = 10):
    ...
    for state in range( max_state):
        ...
        print(f'random seed:{state},ba:{BA_ccp[state]}')
...
def main():
    ...
    dataset, couple)
    # path_feature = 'GSE84133human1_feature_combined_couple_30.000.npy'
    ...
    # path_label = r'D:\python\result\b因子系列\GSE\GSE84133\GSE84133human1/GSE84133human1_full_labels.csv'
