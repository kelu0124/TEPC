...
(1) PDB_data_process.py: load the three-dimension coordinates and B-factor for each protein.  
(2) plot_B_prediction.py: plot the 3D structures of specific protein colored by experimental B-factor and predicted B-factor by different methods.  
