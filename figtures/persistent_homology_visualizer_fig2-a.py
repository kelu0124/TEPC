...
class SimplicialComplex:
    def __init__(self, plottype='1', numVertex=16):
        """
    ...
    def savePolygonCoordinates(self, file_name="polygon_coordinates.txt"):
        """
        Save the coordinates of the polygon to a file.

        Parameters:
        - file_name: Name of the file to save the coordinates
        """
        np.savetxt(file_name, self.vertices)
...
def main():
    ...
    scomplex.savePolygonCoordinates()  # 调用保存多边形坐标的方法
